...
const velopert = async () => {
  try {
    ...
    await page.goto("https://velog.io/@velopert");
    await page.waitForSelector(
      "div#root > div:nth-child(2) > div:last-child > div:last-child > div:last-child > div > div"
    );
    const blogPosts = await page.evaluate(() => {
      ...
      list.forEach((v, i) => {
        ...
        const title = v.querySelector("h2").textContent.trim();
        const time = v.querySelector("div.subinfo > span").textContent.trim();
